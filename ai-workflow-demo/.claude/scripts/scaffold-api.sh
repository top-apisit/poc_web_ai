...
# Create types file
cat > "types/api-$ROUTE_NAME.ts" << 'EOF'
...
sed -i "" "s/{{ROUTE_NAME}}/$ROUTE_NAME/g" "types/api-$ROUTE_NAME.ts"
sed -i "" "s/{{ROUTE_NAME_UPPER}}/$ROUTE_NAME_UPPER/g" "types/api-$ROUTE_NAME.ts"
